...
- `adapters/SendspinKit/client/`: real Swift client adapter source for client- and server-initiated PCM, metadata, artwork, controller, and server-initiated FLAC
